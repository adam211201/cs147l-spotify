...
const ERROR_ALERT = new Error('Oh no! Something went wrong; probably a malformed request or a network error.\nCheck console for more details.');
...
const getMyTopTracks = async (token) => {
	try {
...
export { formatter, fetcher, getMyTopTracks, getAlbumTracks };
